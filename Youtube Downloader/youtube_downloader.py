...
button_360 = Button(mp4_frame,text="Download",command=threading.Thread(target=down_1080).start,image=down,border=0)
...
button_240 = Button(mp4_frame,text="Download",command=threading.Thread(target=down_1080).start,image=down,border=0)
...
button_144 = Button(mp4_frame,text="Download",command=threading.Thread(target=down_1080).start,image=down,border=0)
